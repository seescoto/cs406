...
def test(tests, kLength, xLength):
    ...
    for i in range(1, tests+1):
        ...
        k = tf.genRandomString(kLength) 
        x = tf.genRandomString(xLength)
        prfArr = util.PRF(k, x)
    ...
    print(f"comparison of evens to odds in PRF generated array: \t\t {numEvensPRF/tests:.3f}% : {numOddsPRF/tests:.3f}%")
...
mean of PRF generated array:                                    127.51709639999947
mean of randomly generated array:                               127.47268160000111
avg. range of PRF generated array:                              250.87808000000044
avg. range of randomly generated array:                         250.87969999999783
comparison of evens to odds in PRF generated array:              50.017% : 49.983%
comparison of evens to odds in randomly generated array:         49.992% : 50.008%
